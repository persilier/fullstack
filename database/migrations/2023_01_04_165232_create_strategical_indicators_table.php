...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('strategical_indicators', function (Blueprint $table) {
            $table->id();
            $table->string('code')->unique();
            $table->string('description');
            $table->date('start_date');
            $table->date('end_date');
            $table->unsignedBigInteger('strategical_goal_id');
            $table->foreign('strategical_goal_id')->references('id')->on('strategical_goals')->cascadeOnDelete();
    ...
    {
        Schema::dropIfExists('strategical_indicators');
    }
};
